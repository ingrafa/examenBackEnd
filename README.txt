...
a persistence unit "examenangPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "examenang/pom.xml":
...
artifact ("examenang.war") is already built. You can build
